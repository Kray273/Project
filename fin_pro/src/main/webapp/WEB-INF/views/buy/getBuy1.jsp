...
<input name="po_status" type="hidden" value="${buy.po_status}" /> --%>
		...
		<div class="container totalpricebox">
			<div class="price">
				총 상품금액&nbsp;&nbsp;&nbsp;<span class="price_num"><strong><%=request.getParameter("sum")%></strong>원</span>
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<div class="price total_num">
				총 주문금액<span class="price_num"><strong class="ID_total_price"><%=Integer.parseInt(request.getParameter("sum")) + 3000%></strong>원</span>
			</div>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 130px;"><input type="text" name="po_name"
						class="reci_name" placeholder="이름을 입력해주세요." value="${user.um_ars}"></td>
